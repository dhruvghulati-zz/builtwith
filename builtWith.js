...
const BUILTWITH_API_URL = process.env.BUILTWITH_API_URL;
const BUILTWITH_API_KEY = process.env.BUILTWITH_API_KEY;
const BUILTWITH_TECH = process.argv[2]
const parameters = `KEY=${BUILTWITH_API_KEY}&META=yes&TECH=${BUILTWITH_TECH}`

const REQUEST_URI = `${BUILTWITH_API_URL}?${parameters}`
